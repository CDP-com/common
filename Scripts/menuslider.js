  ...
  $.fn.bigSlide = function(options) {
    ...
    var view = {
      ...
      toggleOpen: function() {
		...
		this.$menu.css("min-width", "252px");
        this.$push.css(settings.side, '20%');
		this.$push.css("width", "79.8%");
		this.$menu.removeClass("offscreen");
		$('#collapsed-menu').addClass("offscreen");
      ...
      toggleClose: function() {
        ...
        controller.changeState();
        this.$menu.css(settings.side, '-12.5%');
        this.$push.css(settings.side, '5%');
		this.$push.css("width", "94.8%");
		this.$menu.addClass("offscreen");
